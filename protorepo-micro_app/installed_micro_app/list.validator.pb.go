...
var _regex_ListMicroAppResponse_List_InstanceId = regexp.MustCompile(`^[0-9a-z]{13}$`)
var _regex_ListMicroAppResponse_List_CurrentVersion = regexp.MustCompile(`^\d+\.\d+\.\d+$`)
var _regex_ListMicroAppResponse_List_AppVersion = regexp.MustCompile(`^\d+\.\d+\.\d+$`)
var _regex_ListMicroAppResponse_List_Homepage = regexp.MustCompile(`^((\/[^\/:\*\?""<>\|\r\n]+)+)|(\/)|[a-zA-Z]:(\\[^\\:\*\?""<>\|\r\n]+)*$`)
var _regex_ListMicroAppResponse_List_Owner = regexp.MustCompile(`^[a-zA-Z0-9][.a-zA-Z0-9_-]{2,31}$`)
var _regex_ListMicroAppResponse_List_Ctime = regexp.MustCompile(`^((?:[1-9][0-9]*)?[0-9]{4})-(1[0-2]|0[1-9])-(3[0-1]|0[1-9]|[1-2][0-9])[T ](2[0-3]|[0-1][0-9]):([0-5][0-9]):[0-5][0-9](\.[0-9]+)?(Z|[+-](?:2[0-3]|[0-1][0-9]):[0-5][0-9])?$`)
var _regex_ListMicroAppResponse_List_Mtime = regexp.MustCompile(`^((?:[1-9][0-9]*)?[0-9]{4})-(1[0-2]|0[1-9])-(3[0-1]|0[1-9]|[1-2][0-9])[T ](2[0-3]|[0-1][0-9]):([0-5][0-9]):[0-5][0-9](\.[0-9]+)?(Z|[+-](?:2[0-3]|[0-1][0-9]):[0-5][0-9])?$`)
...
func (this *ListMicroAppResponse_List) Validate() error {
	...
	if !_regex_ListMicroAppResponse_List_InstanceId.MatchString(this.InstanceId) {
	...
	if !_regex_ListMicroAppResponse_List_CurrentVersion.MatchString(this.CurrentVersion) {
	...
	if !_regex_ListMicroAppResponse_List_AppVersion.MatchString(this.AppVersion) {
	...
	if !_regex_ListMicroAppResponse_List_Homepage.MatchString(this.Homepage) {
	...
	if !_regex_ListMicroAppResponse_List_Owner.MatchString(this.Owner) {
	...
	if !_regex_ListMicroAppResponse_List_Ctime.MatchString(this.Ctime) {
	...
	if !_regex_ListMicroAppResponse_List_Mtime.MatchString(this.Mtime) {
...
var _regex_ListMicroAppResponse_List_Icons_Large = regexp.MustCompile(`^((\/[^\/:\*\?""<>\|\r\n]+)+)|(\/)|[a-zA-Z]:(\\[^\\:\*\?""<>\|\r\n]+)*$`)

func (this *ListMicroAppResponse_List_Icons) Validate() error {
	if !_regex_ListMicroAppResponse_List_Icons_Large.MatchString(this.Large) {
		return github_com_mwitkow_go_proto_validators.FieldError("Large", fmt.Errorf(`value '%v' must be a string conforming to regex "^((\\/[^\\/:\\*\\?\"\"<>\\|\\r\\n]+)+)|(\\/)|[a-zA-Z]:(\\\\[^\\\\:\\*\\?\"\"<>\\|\\r\\n]+)*$"`, this.Large))
	}
	return nil
}

var _regex_ListMicroAppResponse_List_ClonedFrom_Version = regexp.MustCompile(`^\d+\.\d+\.\d+$`)

func (this *ListMicroAppResponse_List_ClonedFrom) Validate() error {
	if !_regex_ListMicroAppResponse_List_ClonedFrom_Version.MatchString(this.Version) {
