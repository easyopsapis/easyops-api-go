...
var _regex_GetMicroAppListRequest_ObjectId = regexp.MustCompile(`^[a-zA-Z_][0-9a-zA-Z_]{0,31}$`)

func (this *GetMicroAppListRequest) Validate() error {
	if !_regex_GetMicroAppListRequest_ObjectId.MatchString(this.ObjectId) {
