...
var _regex_GetStatusRequest_InstanceId = regexp.MustCompile(`^[0-9a-z]{13}$`)

func (this *GetStatusRequest) Validate() error {
	if !_regex_GetStatusRequest_InstanceId.MatchString(this.InstanceId) {
...
func (this *GetStatusResponseWrapper) Validate() error {
	if this.Data != nil {
