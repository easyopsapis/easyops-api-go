...
var _regex_SetDefaultRequest_InstanceId = regexp.MustCompile(`^[0-9a-z]{13}$`)

func (this *SetDefaultRequest) Validate() error {
	if !_regex_SetDefaultRequest_InstanceId.MatchString(this.InstanceId) {
...
func (this *SetDefaultResponseWrapper) Validate() error {
	if this.Data != nil {
