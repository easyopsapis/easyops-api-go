...
func (c *client) DeleteNamespace(ctx context.Context, in *DeleteNamespaceRequest) (*types.Empty, error) {
	out := new(types.Empty)
	err := c.c.Invoke(ctx, _DeleteNamespaceMethodDesc, in, out)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _DeleteNamespaceEndpoint(s Service) giraffe_micro.UnaryEndpoint {
	return func(ctx context.Context, req interface{}) (interface{}, error) {
		return s.DeleteNamespace(ctx, req.(*DeleteNamespaceRequest))
	}
}
...
func RegisterService(s giraffe_micro.Server, srv Service) {
	...
	s.RegisterUnaryEndpoint(_DeleteNamespaceMethodDesc, _DeleteNamespaceEndpoint(srv))
...
var _CreateMethodDesc = &giraffe_micro.MethodDesc{
	Contract: &go_proto_giraffe.Contract{
		Name:    "easyops.api.container.namespace.Create",
		Version: "1.0",
	},
	ServiceName:  "namespace.rpc",
	MethodName:   "Create",
	RequestType:  (*CreateRequest)(nil),
	ResponseType: (*CreateResponse)(nil),
	HttpRule: &go_proto_giraffe.HttpRule{
		Pattern: &go_proto_giraffe.HttpRule_Post{
			Post: "/api/container/v1/namespaces",
		},
		Body:         "",
		ResponseBody: "data",
	},
...
var _DeleteNamespaceMethodDesc = &giraffe_micro.MethodDesc{
	Contract: &go_proto_giraffe.Contract{
		Name:    "easyops.api.container.namespace.DeleteNamespace",
		Version: "1.0",
	},
	ServiceName:  "namespace.rpc",
	MethodName:   "DeleteNamespace",
	RequestType:  (*DeleteNamespaceRequest)(nil),
	ResponseType: (*types.Empty)(nil),
	HttpRule: &go_proto_giraffe.HttpRule{
		Pattern: &go_proto_giraffe.HttpRule_Delete{
			Delete: "/api/container/v1/namespaces/:instanceId",
		},
		Body:         "",
		ResponseBody: "data",
	},
...
var _GetMethodDesc = &giraffe_micro.MethodDesc{
	Contract: &go_proto_giraffe.Contract{
		Name:    "easyops.api.container.namespace.Get",
		Version: "1.0",
	},
	ServiceName:  "namespace.rpc",
	MethodName:   "Get",
	...
	HttpRule: &go_proto_giraffe.HttpRule{
		Pattern: &go_proto_giraffe.HttpRule_Get{
			Get: "/api/container/v1/namespaces/:instanceId",
		},
		Body:         "",
		ResponseBody: "data",
	},
...
var _ListMethodDesc = &giraffe_micro.MethodDesc{
	Contract: &go_proto_giraffe.Contract{
		Name:    "easyops.api.container.namespace.List",
		Version: "1.0",
	},
	ServiceName:  "namespace.rpc",
	MethodName:   "List",
	...
	HttpRule: &go_proto_giraffe.HttpRule{
		Pattern: &go_proto_giraffe.HttpRule_Get{
			Get: "/api/container/v1/namespaces",
		},
		Body:         "",
		ResponseBody: "data",
	},
...
var _UpdateMethodDesc = &giraffe_micro.MethodDesc{
	Contract: &go_proto_giraffe.Contract{
		Name:    "easyops.api.container.namespace.Update",
		Version: "1.0",
	},
	ServiceName:  "namespace.rpc",
	MethodName:   "Update",
	...
	HttpRule: &go_proto_giraffe.HttpRule{
		Pattern: &go_proto_giraffe.HttpRule_Put{
			Put: "/api/container/v1/namespaces/:instanceId",
		},
		Body:         "",
		ResponseBody: "data",
	},
