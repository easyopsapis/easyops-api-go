...
var _regex_UpdateResourceSpecRequest_InstanceId = regexp.MustCompile(`^[0-9a-z]{13}$`)

func (this *UpdateResourceSpecRequest) Validate() error {
	if !_regex_UpdateResourceSpecRequest_InstanceId.MatchString(this.InstanceId) {
...
func (this *UpdateResourceSpecResponseWrapper) Validate() error {
	if this.Data != nil {
