...
var _regex_SQLPackageVersion_Id = regexp.MustCompile(`^[0-9a-z]{13}$`)
var _regex_SQLPackageVersion_Creator = regexp.MustCompile(`^[a-zA-Z0-9][.a-zA-Z0-9_-]{2,31}$`)

func (this *SQLPackageVersion) Validate() error {
	if !_regex_SQLPackageVersion_Id.MatchString(this.Id) {
	...
	if !_regex_SQLPackageVersion_Creator.MatchString(this.Creator) {
