...
var _regex_InstanceQueryStrategy_ObjectId = regexp.MustCompile(`^[a-zA-Z_][0-9a-zA-Z_]{0,31}$`)

func (this *InstanceQueryStrategy) Validate() error {
	if !_regex_InstanceQueryStrategy_ObjectId.MatchString(this.ObjectId) {
