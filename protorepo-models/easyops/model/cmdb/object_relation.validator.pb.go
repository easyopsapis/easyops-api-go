...
var _regex_ObjectRelation_RelationId = regexp.MustCompile(`^[a-zA-Z_][0-9a-zA-Z_]*$`)
...
var _regex_ObjectRelation_Creator = regexp.MustCompile(`^[a-zA-Z0-9][.a-zA-Z0-9_-]{2,31}$`)
