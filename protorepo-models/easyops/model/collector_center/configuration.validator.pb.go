...
var _regex_Configuration_Id = regexp.MustCompile(`[0-9a-f]{24}`)
var _regex_Configuration_TimeRange = regexp.MustCompile(`[0-9]{2}:[0-9]{2}-[0-9]{2}:[0-9]{2}`)

func (this *Configuration) Validate() error {
	if !_regex_Configuration_Id.MatchString(this.Id) {
	...
	if !_regex_Configuration_TimeRange.MatchString(this.TimeRange) {
