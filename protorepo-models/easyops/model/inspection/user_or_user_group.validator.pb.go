...
var _regex_InspectionUserOrUserGroup_InstanceId = regexp.MustCompile(`^[0-9a-z]{13}$`)

func (this *InspectionUserOrUserGroup) Validate() error {
	if !_regex_InspectionUserOrUserGroup_InstanceId.MatchString(this.InstanceId) {
