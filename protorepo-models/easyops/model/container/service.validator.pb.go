...
var _regex_Service_InstanceId = regexp.MustCompile(`^[0-9a-z]{13}$`)
var _regex_Service_ResourceName = regexp.MustCompile(`^[a-z]([-a-z0-9]*[a-z0-9])?$`)
var _regex_Service_CreationTimestamp = regexp.MustCompile(`^((?:[1-9][0-9]*)?[0-9]{4})-(1[0-2]|0[1-9])-(3[0-1]|0[1-9]|[1-2][0-9])[T ](2[0-3]|[0-1][0-9]):([0-5][0-9]):[0-5][0-9](\.[0-9]+)?(Z|[+-](?:2[0-3]|[0-1][0-9]):[0-5][0-9])?$`)
var _regex_Service_Creator = regexp.MustCompile(`^[a-zA-Z0-9][.a-zA-Z0-9_-]{2,31}$`)

func (this *Service) Validate() error {
	if !_regex_Service_InstanceId.MatchString(this.InstanceId) {
	...
	if !_regex_Service_ResourceName.MatchString(this.ResourceName) {
		return github_com_mwitkow_go_proto_validators.FieldError("ResourceName", fmt.Errorf(`value '%v' must be a string conforming to regex "^[a-z]([-a-z0-9]*[a-z0-9])?$"`, this.ResourceName))
	}
	...
	if !_regex_Service_CreationTimestamp.MatchString(this.CreationTimestamp) {
	...
	if !_regex_Service_Creator.MatchString(this.Creator) {
