...
var _regex_IDCRack_InstanceId = regexp.MustCompile(`^[0-9a-z]{13}$`)
var _regex_IDCRack_Ctime = regexp.MustCompile(`^((?:[1-9][0-9]*)?[0-9]{4})-(1[0-2]|0[1-9])-(3[0-1]|0[1-9]|[1-2][0-9])[T ](2[0-3]|[0-1][0-9]):([0-5][0-9]):[0-5][0-9](\.[0-9]+)?(Z|[+-](?:2[0-3]|[0-1][0-9]):[0-5][0-9])?$`)
var _regex_IDCRack_Creator = regexp.MustCompile(`^[a-zA-Z0-9][.a-zA-Z0-9_-]{2,31}$`)

func (this *IDCRack) Validate() error {
	if !_regex_IDCRack_InstanceId.MatchString(this.InstanceId) {
	...
	if !_regex_IDCRack_Ctime.MatchString(this.Ctime) {
	...
	if !_regex_IDCRack_Creator.MatchString(this.Creator) {
