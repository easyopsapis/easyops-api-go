...
var _regex_Host_InstanceId = regexp.MustCompile(`^[0-9a-z]{13}$`)
...
var _regex_Host_Ctime = regexp.MustCompile(`^((?:[1-9][0-9]*)?[0-9]{4})-(1[0-2]|0[1-9])-(3[0-1]|0[1-9]|[1-2][0-9])[T ](2[0-3]|[0-1][0-9]):([0-5][0-9]):[0-5][0-9](\.[0-9]+)?(Z|[+-](?:2[0-3]|[0-1][0-9]):[0-5][0-9])?$`)
var _regex_Host_Creator = regexp.MustCompile(`^[a-zA-Z0-9][.a-zA-Z0-9_-]{2,31}$`)

func (this *Host) Validate() error {
	if !_regex_Host_InstanceId.MatchString(this.InstanceId) {
	...
	if !_regex_Host_Ip.MatchString(this.Ip) {
	...
	if !_regex_Host_Ctime.MatchString(this.Ctime) {
	...
	if !_regex_Host_Creator.MatchString(this.Creator) {
