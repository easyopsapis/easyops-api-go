...
func (this *TranslateRuleListHandlerResponse_DataNames) Validate() error {
	return nil
}
func (this *TranslateRuleListHandlerResponse_TranslateFields) Validate() error {
	return nil
}
func (this *TranslateRuleListHandlerResponse_MatchFields) Validate() error {
	return nil
}
