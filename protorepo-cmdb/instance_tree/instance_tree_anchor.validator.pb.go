...
var _regex_InstanceTreeAnchorRequest_ObjectId = regexp.MustCompile(`^[a-zA-Z_][0-9a-zA-Z_]{0,31}$`)
var _regex_InstanceTreeAnchorRequest_InstanceId = regexp.MustCompile(`^[0-9a-z]{13}$`)

func (this *InstanceTreeAnchorRequest) Validate() error {
	if this.Tree != nil {
		if err := github_com_mwitkow_go_proto_validators.CallValidatorIfExists(this.Tree); err != nil {
			return github_com_mwitkow_go_proto_validators.FieldError("Tree", err)
		}
	}
	if !_regex_InstanceTreeAnchorRequest_ObjectId.MatchString(this.ObjectId) {
	...
	if !_regex_InstanceTreeAnchorRequest_InstanceId.MatchString(this.InstanceId) {
