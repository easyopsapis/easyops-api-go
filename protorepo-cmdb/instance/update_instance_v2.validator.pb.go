...
var _regex_UpdateInstanceV2Request_ObjectId = regexp.MustCompile(`^[a-zA-Z_][0-9a-zA-Z_]{0,31}$`)
var _regex_UpdateInstanceV2Request_InstanceId = regexp.MustCompile(`^[0-9a-z]{13}$`)

func (this *UpdateInstanceV2Request) Validate() error {
	if !_regex_UpdateInstanceV2Request_ObjectId.MatchString(this.ObjectId) {
	...
	if !_regex_UpdateInstanceV2Request_InstanceId.MatchString(this.InstanceId) {
