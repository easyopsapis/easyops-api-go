...
var _regex_DeleteInstanceRequest_ObjectId = regexp.MustCompile(`^[a-zA-Z_][0-9a-zA-Z_]{0,31}$`)
var _regex_DeleteInstanceRequest_InstanceId = regexp.MustCompile(`^[0-9a-z]{13}$`)

func (this *DeleteInstanceRequest) Validate() error {
	if !_regex_DeleteInstanceRequest_ObjectId.MatchString(this.ObjectId) {
	...
	if !_regex_DeleteInstanceRequest_InstanceId.MatchString(this.InstanceId) {
