...
var _regex_ExportInstanceRequest_ObjectId = regexp.MustCompile(`^[a-zA-Z_][0-9a-zA-Z_]{0,31}$`)

func (this *ExportInstanceRequest) Validate() error {
	if !_regex_ExportInstanceRequest_ObjectId.MatchString(this.ObjectId) {
