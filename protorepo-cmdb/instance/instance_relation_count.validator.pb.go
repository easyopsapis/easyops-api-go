...
var _regex_InstanceRelationsCountRequest_ObjectId = regexp.MustCompile(`^[a-zA-Z_][0-9a-zA-Z_]{0,31}$`)
var _regex_InstanceRelationsCountRequest_InstanceId = regexp.MustCompile(`^[0-9a-z]{13}$`)

func (this *InstanceRelationsCountRequest) Validate() error {
	if !_regex_InstanceRelationsCountRequest_ObjectId.MatchString(this.ObjectId) {
	...
	if !_regex_InstanceRelationsCountRequest_InstanceId.MatchString(this.InstanceId) {
