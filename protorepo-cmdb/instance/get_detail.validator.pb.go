...
var _regex_GetDetailRequest_ObjectId = regexp.MustCompile(`^[a-zA-Z_][0-9a-zA-Z_]{0,31}$`)
var _regex_GetDetailRequest_InstanceId = regexp.MustCompile(`^[0-9a-z]{13}$`)

func (this *GetDetailRequest) Validate() error {
	if !_regex_GetDetailRequest_ObjectId.MatchString(this.ObjectId) {
	...
	if !_regex_GetDetailRequest_InstanceId.MatchString(this.InstanceId) {
