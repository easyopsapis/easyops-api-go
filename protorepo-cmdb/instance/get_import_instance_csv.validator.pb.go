...
var _regex_GetImportInstanceCsvRequest_ObjectId = regexp.MustCompile(`^[a-zA-Z_][0-9a-zA-Z_]{0,31}$`)

func (this *GetImportInstanceCsvRequest) Validate() error {
	if !_regex_GetImportInstanceCsvRequest_ObjectId.MatchString(this.ObjectId) {
