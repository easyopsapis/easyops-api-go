...
var _regex_DeleteStateRequest_ObjectId = regexp.MustCompile(`^[a-zA-Z_][0-9a-zA-Z_]{0,31}$`)
var _regex_DeleteStateRequest_InstanceId = regexp.MustCompile(`^[0-9a-z]{13}$`)
var _regex_DeleteStateRequest_User = regexp.MustCompile(`^[a-zA-Z0-9][.a-zA-Z0-9_-]{2,31}$`)

func (this *DeleteStateRequest) Validate() error {
	if !_regex_DeleteStateRequest_ObjectId.MatchString(this.ObjectId) {
	...
	if !_regex_DeleteStateRequest_InstanceId.MatchString(this.InstanceId) {
	...
	if !_regex_DeleteStateRequest_User.MatchString(this.User) {
