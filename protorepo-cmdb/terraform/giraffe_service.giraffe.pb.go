...
var _DeleteStateMethodDesc = &giraffe_micro.MethodDesc{
	Contract: &go_proto_giraffe.Contract{
		Name:    "easyops.api.cmdb.terraform.DeleteState",
		Version: "1.0",
	},
	ServiceName:  "terraform.rpc",
	MethodName:   "DeleteState",
	RequestType:  (*DeleteStateRequest)(nil),
	ResponseType: (*types.Empty)(nil),
	HttpRule: &go_proto_giraffe.HttpRule{
		Pattern: &go_proto_giraffe.HttpRule_Delete{
			Delete: "/api/terraform/v1/object/:objectId/instance/:instanceId/state",
		},
		Body:         "",
		ResponseBody: "data",
	},
...
var _GetStateMethodDesc = &giraffe_micro.MethodDesc{
	Contract: &go_proto_giraffe.Contract{
		Name:    "easyops.api.cmdb.terraform.GetState",
		Version: "1.0",
	},
	ServiceName:  "terraform.rpc",
	MethodName:   "GetState",
	...
	HttpRule: &go_proto_giraffe.HttpRule{
		Pattern: &go_proto_giraffe.HttpRule_Get{
			Get: "/api/terraform/v1/object/:objectId/instance/:instanceId/state",
		},
		Body:         "",
		ResponseBody: "",
	},
...
var _LockStateMethodDesc = &giraffe_micro.MethodDesc{
	Contract: &go_proto_giraffe.Contract{
		Name:    "easyops.api.cmdb.terraform.LockState",
		Version: "1.0",
	},
	ServiceName:  "terraform.rpc",
	...
	HttpRule: &go_proto_giraffe.HttpRule{
		Pattern: &go_proto_giraffe.HttpRule_Post{
			Post: "/api/terraform/v1/object/:objectId/instance/:instanceId/state/lock",
		},
		Body:         "body",
		ResponseBody: "data",
	},
...
var _UnLockStateMethodDesc = &giraffe_micro.MethodDesc{
	Contract: &go_proto_giraffe.Contract{
		Name:    "easyops.api.cmdb.terraform.UnLockState",
		Version: "1.0",
	},
	ServiceName:  "terraform.rpc",
	...
	HttpRule: &go_proto_giraffe.HttpRule{
		Pattern: &go_proto_giraffe.HttpRule_Post{
			Post: "/api/terraform/v1/object/:objectId/instance/:instanceId/state/unlock",
		},
		Body:         "body",
		ResponseBody: "data",
	},
...
var _UpdateStateMethodDesc = &giraffe_micro.MethodDesc{
	Contract: &go_proto_giraffe.Contract{
		Name:    "easyops.api.cmdb.terraform.UpdateState",
		Version: "1.0",
	},
	ServiceName:  "terraform.rpc",
	...
	HttpRule: &go_proto_giraffe.HttpRule{
		Pattern: &go_proto_giraffe.HttpRule_Post{
			Post: "/api/terraform/v1/object/:objectId/instance/:instanceId/state",
		},
		Body:         "body",
		ResponseBody: "data",
	},
