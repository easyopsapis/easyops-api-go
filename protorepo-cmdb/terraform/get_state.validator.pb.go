...
var _regex_GetStateRequest_ObjectId = regexp.MustCompile(`^[a-zA-Z_][0-9a-zA-Z_]{0,31}$`)
var _regex_GetStateRequest_InstanceId = regexp.MustCompile(`^[0-9a-z]{13}$`)
var _regex_GetStateRequest_User = regexp.MustCompile(`^[a-zA-Z0-9][.a-zA-Z0-9_-]{2,31}$`)

func (this *GetStateRequest) Validate() error {
	if !_regex_GetStateRequest_ObjectId.MatchString(this.ObjectId) {
	...
	if !_regex_GetStateRequest_InstanceId.MatchString(this.InstanceId) {
	...
	if !_regex_GetStateRequest_User.MatchString(this.User) {
