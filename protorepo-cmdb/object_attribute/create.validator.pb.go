...
var _regex_CreateRequest_ObjectId = regexp.MustCompile(`^[a-zA-Z_][0-9a-zA-Z_]{0,31}$`)
var _regex_CreateRequest_Id = regexp.MustCompile(`^[a-zA-Z_][0-9a-zA-Z_]{0,31}$`)

func (this *CreateRequest) Validate() error {
	if !_regex_CreateRequest_ObjectId.MatchString(this.ObjectId) {
