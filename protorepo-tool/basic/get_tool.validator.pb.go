...
var _regex_GetToolRequest_ToolId = regexp.MustCompile(`^[a-fA-F0-9]{32}$`)
var _regex_GetToolRequest_VId = regexp.MustCompile(`^[a-fA-F0-9]{32}$`)

func (this *GetToolRequest) Validate() error {
	if !_regex_GetToolRequest_ToolId.MatchString(this.ToolId) {
	...
	if !_regex_GetToolRequest_VId.MatchString(this.VId) {
