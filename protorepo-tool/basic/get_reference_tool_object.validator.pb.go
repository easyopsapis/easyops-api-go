...
var _regex_GetReferenceToolObjectRequest_ToolId = regexp.MustCompile(`^[a-fA-F0-9]{32}$`)

func (this *GetReferenceToolObjectRequest) Validate() error {
	if !_regex_GetReferenceToolObjectRequest_ToolId.MatchString(this.ToolId) {
...
var _regex_GetReferenceToolObjectResponse_Data_Id = regexp.MustCompile(`^[a-fA-F0-9]{32}$`)

func (this *GetReferenceToolObjectResponse_Data) Validate() error {
	if !_regex_GetReferenceToolObjectResponse_Data_Id.MatchString(this.Id) {
...
func (this *GetReferenceToolObjectResponse_Data_Metadata) Validate() error {
	return nil
}
func (this *GetReferenceToolObjectResponseWrapper) Validate() error {
	if this.Data != nil {
