...
var _regex_GetSignRequest_PackageId = regexp.MustCompile(`^[?a-zA-Z0-9]{8}-[?a-zA-Z0-9]{4}-[?a-zA-Z0-9]{4}-[?a-zA-Z0-9]{4}-[?a-zA-Z0-9]{12}$`)
var _regex_GetSignRequest_VersionId = regexp.MustCompile(`^[?a-zA-Z0-9]{8}-[?a-zA-Z0-9]{4}-[?a-zA-Z0-9]{4}-[?a-zA-Z0-9]{4}-[?a-zA-Z0-9]{12}$`)

func (this *GetSignRequest) Validate() error {
	if !_regex_GetSignRequest_PackageId.MatchString(this.PackageId) {
	...
	if !_regex_GetSignRequest_VersionId.MatchString(this.VersionId) {
...
func (this *GetSignResponse) Validate() error {
	if this.Sign != nil {
...
func (this *GetSignResponseWrapper) Validate() error {
	if this.Data != nil {
