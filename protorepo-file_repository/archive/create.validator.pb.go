...
var _regex_CreateResponse_VersionId = regexp.MustCompile(`^[?a-zA-Z0-9]{8}-[?a-zA-Z0-9]{4}-[?a-zA-Z0-9]{4}-[?a-zA-Z0-9]{4}-[?a-zA-Z0-9]{12}$`)

func (this *CreateResponse) Validate() error {
	if !_regex_CreateResponse_VersionId.MatchString(this.VersionId) {
