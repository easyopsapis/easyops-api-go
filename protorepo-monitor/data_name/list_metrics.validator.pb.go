...
func (this *ListMetricsRequest) Validate() error {
	if !(this.Page > 0) {
	...
	if !(this.PageSize < 301) {
		return github_com_mwitkow_go_proto_validators.FieldError("PageSize", fmt.Errorf(`value '%v' must be less than '301'`, this.PageSize))
	}
	return nil
}
func (this *ListMetricsResponse) Validate() error {
	if !(this.Page > 0) {
		return github_com_mwitkow_go_proto_validators.FieldError("Page", fmt.Errorf(`value '%v' must be greater than '0'`, this.Page))
	}
	if !(this.PageSize > 0) {
...
func (this *ListMetricsResponseWrapper) Validate() error {
	if this.Data != nil {
