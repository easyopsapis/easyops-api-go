...
var _regex_GetNotRecoverAlertEventListRequest_ObjectId = regexp.MustCompile(`^[a-zA-Z_][0-9a-zA-Z_]{0,31}$`)
var _regex_GetNotRecoverAlertEventListRequest_InstanceId = regexp.MustCompile(`^[0-9a-z]{13}$`)

func (this *GetNotRecoverAlertEventListRequest) Validate() error {
	if !_regex_GetNotRecoverAlertEventListRequest_ObjectId.MatchString(this.ObjectId) {
	...
	if !_regex_GetNotRecoverAlertEventListRequest_InstanceId.MatchString(this.InstanceId) {
...
func (this *GetNotRecoverAlertEventListResponseWrapper) Validate() error {
	if this.Data != nil {
