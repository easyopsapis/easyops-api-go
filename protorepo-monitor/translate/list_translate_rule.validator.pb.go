...
func (this *ListTranslateRuleRequest) Validate() error {
	if !(this.Page > 0) {
...
func (this *ListTranslateRuleResponse) Validate() error {
	if !(this.Page > 0) {
		return github_com_mwitkow_go_proto_validators.FieldError("Page", fmt.Errorf(`value '%v' must be greater than '0'`, this.Page))
	}
	if !(this.PageSize > 0) {
...
func (this *ListTranslateRuleResponseWrapper) Validate() error {
	if this.Data != nil {
