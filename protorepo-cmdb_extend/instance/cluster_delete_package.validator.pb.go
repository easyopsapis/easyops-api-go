...
var _regex_ClusterDeletePackageRequest_InstanceId = regexp.MustCompile(`^[0-9a-z]{13}$`)

func (this *ClusterDeletePackageRequest) Validate() error {
	if !_regex_ClusterDeletePackageRequest_InstanceId.MatchString(this.InstanceId) {
