...
var _regex_DeleteClusterDeviceRequest_InstanceId = regexp.MustCompile(`^[0-9a-z]{13}$`)

func (this *DeleteClusterDeviceRequest) Validate() error {
	if !_regex_DeleteClusterDeviceRequest_InstanceId.MatchString(this.InstanceId) {
