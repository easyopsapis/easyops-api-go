...
var _regex_ClusterUpdatePackageRequest_InstanceId = regexp.MustCompile(`^[0-9a-z]{13}$`)

func (this *ClusterUpdatePackageRequest) Validate() error {
	if !_regex_ClusterUpdatePackageRequest_InstanceId.MatchString(this.InstanceId) {
