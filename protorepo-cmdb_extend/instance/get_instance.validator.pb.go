...
var _regex_GetInstanceRequest_ObjectId = regexp.MustCompile(`^[a-zA-Z_][0-9a-zA-Z_]{0,31}$`)
var _regex_GetInstanceRequest_InstanceId = regexp.MustCompile(`^[0-9a-z]{13}$`)

func (this *GetInstanceRequest) Validate() error {
	if !_regex_GetInstanceRequest_ObjectId.MatchString(this.ObjectId) {
	...
	if !_regex_GetInstanceRequest_InstanceId.MatchString(this.InstanceId) {
