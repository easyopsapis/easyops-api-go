...
var _regex_SearchSubSystemAllRequest_SystemInstanceId = regexp.MustCompile(`^[0-9a-z]{13}$`)

func (this *SearchSubSystemAllRequest) Validate() error {
	if !_regex_SearchSubSystemAllRequest_SystemInstanceId.MatchString(this.SystemInstanceId) {
