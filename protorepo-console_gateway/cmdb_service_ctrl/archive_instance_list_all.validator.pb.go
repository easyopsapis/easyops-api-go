...
var _regex_ArchiveInstanceListAllRequest_ObjectId = regexp.MustCompile(`^[a-zA-Z_][0-9a-zA-Z_]{0,31}$`)

func (this *ArchiveInstanceListAllRequest) Validate() error {
	if !_regex_ArchiveInstanceListAllRequest_ObjectId.MatchString(this.ObjectId) {
...
func (this *ArchiveInstanceListAllResponseWrapper) Validate() error {
	if this.Data != nil {
