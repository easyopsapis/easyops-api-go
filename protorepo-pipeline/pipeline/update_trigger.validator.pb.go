...
var _regex_UpdateTriggerRequest_Id = regexp.MustCompile(`^[0-9a-z]{13}$`)

func (this *UpdateTriggerRequest) Validate() error {
	if !_regex_UpdateTriggerRequest_Id.MatchString(this.Id) {
...
func (this *UpdateTriggerResponseWrapper) Validate() error {
	if this.Data != nil {
