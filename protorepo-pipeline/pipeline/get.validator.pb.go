...
var _regex_GetRequest_ProjectId = regexp.MustCompile(`^[0-9a-z]{13}$`)
var _regex_GetRequest_PipelineId = regexp.MustCompile(`^[0-9a-z]{13}$`)

func (this *GetRequest) Validate() error {
	if !_regex_GetRequest_ProjectId.MatchString(this.ProjectId) {
	...
	if !_regex_GetRequest_PipelineId.MatchString(this.PipelineId) {
