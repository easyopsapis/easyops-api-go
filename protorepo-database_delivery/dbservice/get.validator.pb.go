...
var _regex_GetDBServiceRequest_DbServiceId = regexp.MustCompile(`^[0-9a-z]{13}$`)

func (this *GetDBServiceRequest) Validate() error {
	if !_regex_GetDBServiceRequest_DbServiceId.MatchString(this.DbServiceId) {
...
var _regex_GetDBServiceResponse_InstanceId = regexp.MustCompile(`^[0-9a-z]{13}$`)
...
func (this *GetDBServiceResponse) Validate() error {
	...
	if !_regex_GetDBServiceResponse_InstanceId.MatchString(this.InstanceId) {
...
var _regex_GetDBServiceResponse_Owner_InstanceId = regexp.MustCompile(`^[0-9a-z]{13}$`)
var _regex_GetDBServiceResponse_Owner_UserEmail = regexp.MustCompile(`^([A-Za-z0-9_\-\.])+\@([A-Za-z0-9_\-\.])+\.([A-Za-z]{2,8})$`)
var _regex_GetDBServiceResponse_Owner_Nickname = regexp.MustCompile(`.*`)

func (this *GetDBServiceResponse_Owner) Validate() error {
	if !_regex_GetDBServiceResponse_Owner_InstanceId.MatchString(this.InstanceId) {
		return github_com_mwitkow_go_proto_validators.FieldError("InstanceId", fmt.Errorf(`value '%v' must be a string conforming to regex "^[0-9a-z]{13}$"`, this.InstanceId))
	}
	if !_regex_GetDBServiceResponse_Owner_UserEmail.MatchString(this.UserEmail) {
	...
	if !_regex_GetDBServiceResponse_Owner_Nickname.MatchString(this.Nickname) {
