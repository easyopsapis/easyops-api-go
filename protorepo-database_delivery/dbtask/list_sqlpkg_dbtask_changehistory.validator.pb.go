...
var _regex_ListSQLPackageDBTaskChangeHistoryRequest_DbServiceId = regexp.MustCompile(`^[0-9a-z]{13}$`)

func (this *ListSQLPackageDBTaskChangeHistoryRequest) Validate() error {
	if !_regex_ListSQLPackageDBTaskChangeHistoryRequest_DbServiceId.MatchString(this.DbServiceId) {
...
func (this *ListSQLPackageDBTaskChangeHistoryResponse) Validate() error {
	if !(this.Page > 0) {
		return github_com_mwitkow_go_proto_validators.FieldError("Page", fmt.Errorf(`value '%v' must be greater than '0'`, this.Page))
	}
	if !(this.PageSize > 0) {
...
func (this *ListSQLPackageDBTaskChangeHistoryResponseWrapper) Validate() error {
	if this.Data != nil {
