...
var _regex_CreateConfigurationTemplateRequest_TimeRange = regexp.MustCompile(`[0-9]{2}:[0-9]{2}-[0-9]{2}:[0-9]{2}`)
...
func (this *CreateConfigurationTemplateRequest) Validate() error {
	...
	if !_regex_CreateConfigurationTemplateRequest_TimeRange.MatchString(this.TimeRange) {
...
var _regex_CreateConfigurationTemplateResponse_Id = regexp.MustCompile(`[0-9a-f]{24}`)

func (this *CreateConfigurationTemplateResponse) Validate() error {
	if !_regex_CreateConfigurationTemplateResponse_Id.MatchString(this.Id) {
...
func (this *CreateConfigurationTemplateResponseWrapper) Validate() error {
	if this.Data != nil {
