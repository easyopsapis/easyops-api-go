...
var _regex_CreateConfigurationRequest_TimeRange = regexp.MustCompile(`[0-9]{2}:[0-9]{2}-[0-9]{2}:[0-9]{2}`)
...
func (this *CreateConfigurationRequest) Validate() error {
	...
	if !_regex_CreateConfigurationRequest_TimeRange.MatchString(this.TimeRange) {
...
var _regex_CreateConfigurationResponse_Id = regexp.MustCompile(`[0-9a-f]{24}`)

func (this *CreateConfigurationResponse) Validate() error {
	if !_regex_CreateConfigurationResponse_Id.MatchString(this.Id) {
