...
var _regex_UpdateConfigurationRequest_Id = regexp.MustCompile(`[0-9a-f]{24}`)
var _regex_UpdateConfigurationRequest_TimeRange = regexp.MustCompile(`[0-9]{2}:[0-9]{2}-[0-9]{2}:[0-9]{2}`)

func (this *UpdateConfigurationRequest) Validate() error {
	if !_regex_UpdateConfigurationRequest_Id.MatchString(this.Id) {
	...
	if !_regex_UpdateConfigurationRequest_TimeRange.MatchString(this.TimeRange) {
...
var _regex_UpdateConfigurationResponse_Id = regexp.MustCompile(`[0-9a-f]{24}`)

func (this *UpdateConfigurationResponse) Validate() error {
	if !_regex_UpdateConfigurationResponse_Id.MatchString(this.Id) {
		return github_com_mwitkow_go_proto_validators.FieldError("Id", fmt.Errorf(`value '%v' must be a string conforming to regex "[0-9a-f]{24}"`, this.Id))
	}
	return nil
}
