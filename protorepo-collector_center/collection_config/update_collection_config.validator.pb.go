...
var _regex_UpdateCollectionConfigRequest_Id = regexp.MustCompile(`[0-9a-f]{24}`)
var _regex_UpdateCollectionConfigRequest_TimeRange = regexp.MustCompile(`[0-9]{2}:[0-9]{2}-[0-9]{2}:[0-9]{2}`)
var _regex_UpdateCollectionConfigRequest_ClazzId = regexp.MustCompile(`[0-9a-f]{24}`)

func (this *UpdateCollectionConfigRequest) Validate() error {
	if !_regex_UpdateCollectionConfigRequest_Id.MatchString(this.Id) {
	...
	if !_regex_UpdateCollectionConfigRequest_TimeRange.MatchString(this.TimeRange) {
	...
	if !_regex_UpdateCollectionConfigRequest_ClazzId.MatchString(this.ClazzId) {
...
func (this *UpdateCollectionConfigRequest_Kwargs) Validate() error {
	if this.Value != nil {
...
func (this *UpdateCollectionConfigRequest_Script) Validate() error {
	return nil
}
func (this *UpdateCollectionConfigRequest_HostRange) Validate() error {
...
func (this *UpdateCollectionConfigRequest_HostRange_Query) Validate() error {
	if this.Value != nil {
		if err := github_com_mwitkow_go_proto_validators.CallValidatorIfExists(this.Value); err != nil {
			return github_com_mwitkow_go_proto_validators.FieldError("Value", err)
		}
...
var _regex_UpdateCollectionConfigResponse_Id = regexp.MustCompile(`[0-9a-f]{24}`)

func (this *UpdateCollectionConfigResponse) Validate() error {
	if !_regex_UpdateCollectionConfigResponse_Id.MatchString(this.Id) {
		return github_com_mwitkow_go_proto_validators.FieldError("Id", fmt.Errorf(`value '%v' must be a string conforming to regex "[0-9a-f]{24}"`, this.Id))
	}
	return nil
}
func (this *UpdateCollectionConfigResponseWrapper) Validate() error {
	if this.Data != nil {
