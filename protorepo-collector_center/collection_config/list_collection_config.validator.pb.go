...
var _regex_ListCollectionConfigResponse_List_Id = regexp.MustCompile(`[0-9a-f]{24}`)
var _regex_ListCollectionConfigResponse_List_TimeRange = regexp.MustCompile(`[0-9]{2}:[0-9]{2}-[0-9]{2}:[0-9]{2}`)
var _regex_ListCollectionConfigResponse_List_ClazzId = regexp.MustCompile(`[0-9a-f]{24}`)

func (this *ListCollectionConfigResponse_List) Validate() error {
	if !_regex_ListCollectionConfigResponse_List_Id.MatchString(this.Id) {
	...
	if !_regex_ListCollectionConfigResponse_List_TimeRange.MatchString(this.TimeRange) {
	...
	if !_regex_ListCollectionConfigResponse_List_ClazzId.MatchString(this.ClazzId) {
...
func (this *ListCollectionConfigResponse_List_Kwargs) Validate() error {
	if this.Value != nil {
...
func (this *ListCollectionConfigResponse_List_Env) Validate() error {
	if this.Value != nil {
		if err := github_com_mwitkow_go_proto_validators.CallValidatorIfExists(this.Value); err != nil {
			return github_com_mwitkow_go_proto_validators.FieldError("Value", err)
		}
...
func (this *ListCollectionConfigResponse_List_Script) Validate() error {
	return nil
}
func (this *ListCollectionConfigResponse_List_HostRange) Validate() error {
...
func (this *ListCollectionConfigResponse_List_HostRange_Query) Validate() error {
	if this.Value != nil {
		if err := github_com_mwitkow_go_proto_validators.CallValidatorIfExists(this.Value); err != nil {
			return github_com_mwitkow_go_proto_validators.FieldError("Value", err)
		}
