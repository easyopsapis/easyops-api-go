...
var _regex_GetStatisticsRequest_PluginId = regexp.MustCompile(`^[a-zA-Z_][0-9a-zA-Z_]{0,31}$`)

func (this *GetStatisticsRequest) Validate() error {
	if !_regex_GetStatisticsRequest_PluginId.MatchString(this.PluginId) {
...
var _regex_GetStatisticsResponse_InstanceId = regexp.MustCompile(`^[0-9a-z]{13}$`)
var _regex_GetStatisticsResponse_Score = regexp.MustCompile(`^\d+(\.\d+)?$`)
...
func (this *GetStatisticsResponse) Validate() error {
	...
	if !_regex_GetStatisticsResponse_InstanceId.MatchString(this.InstanceId) {
