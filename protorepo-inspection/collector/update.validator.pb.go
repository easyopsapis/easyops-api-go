...
var _regex_UpdateCollectorRequest_PluginId = regexp.MustCompile(`^[a-zA-Z_][0-9a-zA-Z_]{0,31}$`)
var _regex_UpdateCollectorRequest_CollectorId = regexp.MustCompile(`^[0-9a-fA-F]{24}$`)

func (this *UpdateCollectorRequest) Validate() error {
	if !_regex_UpdateCollectorRequest_PluginId.MatchString(this.PluginId) {
	...
	if !_regex_UpdateCollectorRequest_CollectorId.MatchString(this.CollectorId) {
