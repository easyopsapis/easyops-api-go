...
var _regex_GetCollectorRequest_PluginId = regexp.MustCompile(`^[a-zA-Z_][0-9a-zA-Z_]{0,31}$`)
var _regex_GetCollectorRequest_CollectorId = regexp.MustCompile(`^[0-9a-fA-F]{24}$`)

func (this *GetCollectorRequest) Validate() error {
	if !_regex_GetCollectorRequest_PluginId.MatchString(this.PluginId) {
	...
	if !_regex_GetCollectorRequest_CollectorId.MatchString(this.CollectorId) {
