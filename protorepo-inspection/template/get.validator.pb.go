...
var _regex_GetTemplateRequest_PluginId = regexp.MustCompile(`^[a-zA-Z_][0-9a-zA-Z_]{0,31}$`)
var _regex_GetTemplateRequest_TemplateId = regexp.MustCompile(`^[0-9a-fA-F]{24}$`)

func (this *GetTemplateRequest) Validate() error {
	if !_regex_GetTemplateRequest_PluginId.MatchString(this.PluginId) {
	...
	if !_regex_GetTemplateRequest_TemplateId.MatchString(this.TemplateId) {
...
func (this *GetTemplateResponseWrapper) Validate() error {
	if this.Data != nil {
