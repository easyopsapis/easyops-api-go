...
var _regex_DeleteInspectionInfoRequest_PluginId = regexp.MustCompile(`^[a-zA-Z_][0-9a-zA-Z_]{0,31}$`)

func (this *DeleteInspectionInfoRequest) Validate() error {
	if !_regex_DeleteInspectionInfoRequest_PluginId.MatchString(this.PluginId) {
