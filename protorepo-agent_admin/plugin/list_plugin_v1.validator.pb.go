...
func (this *ListPluginV1Response_List) Validate() error {
	if this.LastestVersion != nil {
		if err := github_com_mwitkow_go_proto_validators.CallValidatorIfExists(this.LastestVersion); err != nil {
			return github_com_mwitkow_go_proto_validators.FieldError("LastestVersion", err)
		}
	}
	return nil
}
func (this *ListPluginV1Response_List_LastestVersion) Validate() error {
	return nil
}
