...
var _regex_ListServiceInfoRequest_ObjectId = regexp.MustCompile(`^[a-zA-Z_][0-9a-zA-Z_]{0,31}$`)

func (this *ListServiceInfoRequest) Validate() error {
	if !_regex_ListServiceInfoRequest_ObjectId.MatchString(this.ObjectId) {
...
func (this *ListServiceInfoResponse) Validate() error {
	if !(this.Page > 0) {
...
func (this *ListServiceInfoResponseWrapper) Validate() error {
	if this.Data != nil {
