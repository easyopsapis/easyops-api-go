...
var _regex_ListUserSettingRequest_Types = regexp.MustCompile(`^([^,]*\,)*[^,]*$`)
...
func (this *ListUserSettingRequest) Validate() error {
	...
	if !_regex_ListUserSettingRequest_Types.MatchString(this.Types) {
		return github_com_mwitkow_go_proto_validators.FieldError("Types", fmt.Errorf(`value '%v' must be a string conforming to regex "^([^,]*\\,)*[^,]*$"`, this.Types))
	}
	return nil
}
...
func (this *ListUserSettingResponse_List_DetailDisplayList) Validate() error {
	return nil
}
